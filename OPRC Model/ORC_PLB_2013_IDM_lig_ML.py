...
X_train_1 = np.load("ORC PLB IDM 2013/ollivier_train_set_2013_IDM_model_4.npy", allow_pickle=True)
X_test_1 = np.load("ORC PLB IDM 2013/ollivier_test_set_2013_IDM_model_4.npy", allow_pickle=True)

X_train_2 = np.load("ORC PLB IDM 2013/lig_C_2013_ollivier_IDM_train.npy", allow_pickle=True)
X_test_2 = np.load("ORC PLB IDM 2013/lig_C_2013_ollivier_IDM_test.npy", allow_pickle=True)
X_train_3 = np.load("ORC PLB IDM 2013/lig_CN_2013_ollivier_IDM_train.npy", allow_pickle=True)
X_test_3 = np.load("ORC PLB IDM 2013/lig_CN_2013_ollivier_IDM_test.npy", allow_pickle=True)
X_train_4 = np.load("ORC PLB IDM 2013/lig_CO_2013_ollivier_IDM_train.npy", allow_pickle=True)
X_test_4 = np.load("ORC PLB IDM 2013/lig_CO_2013_ollivier_IDM_test.npy", allow_pickle=True)
X_train_5 = np.load("ORC PLB IDM 2013/lig_CNO_2013_ollivier_IDM_train.npy", allow_pickle=True)
X_test_5 = np.load("ORC PLB IDM 2013/lig_CNO_2013_ollivier_IDM_test.npy", allow_pickle=True)
X_train_6 = np.load("ORC PLB IDM 2013/lig_CNOSFPClBrI_2013_ollivier_IDM_train.npy", allow_pickle=True)
X_test_6 = np.load("ORC PLB IDM 2013/lig_CNOSFPClBrI_2013_ollivier_IDM_test.npy", allow_pickle=True)
...
#print(np.shape(X_test_2), np.shape(X_train_2))
X_test_1 = np.reshape(X_test_1, (len(X_test_1), 36*10*15*20))
X_train_1 = np.reshape(X_train_1, (len(X_train_1), 36*10*15*20))
X_test_2 = np.reshape(X_test_2, (len(X_test_2), 150*20))
X_train_2 = np.reshape(X_train_2, (len(X_train_2), 150*20))
...
for i in range(len(X_test_1)):
    X_test.append(list(X_test_1[i])+list(X_test_2[i])+list(X_test_3[i])+list(X_test_4[i])+list(X_test_5[i])+list(X_test_6[i]))

X_train = []
for i in range(len(X_train_1)):
    X_train.append(list(X_train_1[i])+list(X_train_2[i])+list(X_train_3[i])+list(X_train_4[i])+list(X_train_5[i])+list(X_train_6[i]))
...
np.save("ORC PLB IEM 2013/ollivier_results_2013_IDM_lig_multiscale_model_4.npy", [results, gbt_values, rf_values])