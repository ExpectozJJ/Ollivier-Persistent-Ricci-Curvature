...
X_train_1 = np.load("ORC PLB IDM 2016/ollivier_train_set_2016_IDM_model_4.npy", allow_pickle=True)
X_test_1 = np.load("ORC PLB IDM 2016/ollivier_test_set_2016_IDM_model_4.npy", allow_pickle=True)
X_train_2 = np.load("ORC PLB IDM 2016/lig_C_2016_ollivier_IDM_train.npy", allow_pickle=True)
X_test_2 = np.load("ORC PLB IDM 2016/lig_C_2016_ollivier_IDM_test.npy", allow_pickle=True)
X_train_3 = np.load("ORC PLB IDM 2016/lig_CN_2016_ollivier_IDM_train.npy", allow_pickle=True)
X_test_3 = np.load("ORC PLB IDM 2016/lig_CN_2016_ollivier_IDM_test.npy", allow_pickle=True)
X_train_4 = np.load("ORC PLB IDM 2016/lig_CO_2016_ollivier_IDM_train.npy", allow_pickle=True)
X_test_4 = np.load("ORC PLB IDM 2016/lig_CO_2016_ollivier_IDM_test.npy", allow_pickle=True)
X_train_5 = np.load("ORC PLB IDM 2016/lig_CNO_2016_ollivier_IDM_train.npy", allow_pickle=True)
X_test_5 = np.load("ORC PLB IDM 2016/lig_CNO_2016_ollivier_IDM_test.npy", allow_pickle=True)
X_train_6 = np.load("ORC PLB IDM 2016/lig_CNOSFPClBrI_2016_ollivier_IDM_train.npy", allow_pickle=True)
X_test_6 = np.load("ORC PLB IDM 2016/lig_CNOSFPClBrI_2016_ollivier_IDM_test.npy", allow_pickle=True)
...
np.save("ORC PLB IEM 2016/ollivier_results_2016_IDM_lig_multiscale_model_4.npy", [results, gbt_values, rf_values])