...
X_train_1 = np.load("ORC PLB IDM 2007/ollivier_train_set_2007_IDM_model_4.npy", allow_pickle=True)
X_test_1 = np.load("ORC PLB IDM 2007/ollivier_test_set_2007_IDM_model_4.npy", allow_pickle=True)
X_train_2 = np.load("ORC PLB IDM 2007/lig_C_2007_ollivier_IDM_train.npy", allow_pickle=True)
X_test_2 = np.load("ORC PLB IDM 2007/lig_C_2007_ollivier_IDM_test.npy", allow_pickle=True)
X_train_3 = np.load("ORC PLB IDM 2007/lig_CN_2007_ollivier_IDM_train.npy", allow_pickle=True)
X_test_3 = np.load("ORC PLB IDM 2007/lig_CN_2007_ollivier_IDM_test.npy", allow_pickle=True)
X_train_4 = np.load("ORC PLB IDM 2007/lig_CO_2007_ollivier_IDM_train.npy", allow_pickle=True)
X_test_4 = np.load("ORC PLB IDM 2007/lig_CO_2007_ollivier_IDM_test.npy", allow_pickle=True)
X_train_5 = np.load("ORC PLB IDM 2007/lig_CNO_2007_ollivier_IDM_train.npy", allow_pickle=True)
X_test_5 = np.load("ORC PLB IDM 2007/lig_CNO_2007_ollivier_IDM_test.npy", allow_pickle=True)
X_train_6 = np.load("ORC PLB IDM 2007/lig_CNOSFPClBrI_2007_ollivier_IDM_train.npy", allow_pickle=True)
X_test_6 = np.load("ORC PLB IDM 2007/lig_CNOSFPClBrI_2007_ollivier_IDM_test.npy", allow_pickle=True)
...
np.save("ORC PLB IEM 2007/ollivier_results_2007_IDM_lig_multiscale_model_4.npy", [results, gbt_values, rf_values])